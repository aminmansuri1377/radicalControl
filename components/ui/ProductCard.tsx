...
export function ProductCard({
  ...
  return (
    <article className="relative flex min-h-[315px] flex-col rounded-2xl border border-primary bg-white p-3 text-right shadow-sm transition hover:-translate-y-1 hover:shadow-lg">
      <span
